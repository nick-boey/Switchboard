...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------ |
| design-language.stories.tsx | Applied '50s switchboard visual system: palette, embossed surfaces, type ramp, jacks/lamps/labels/buttons, device framing                       | open        | open   |
